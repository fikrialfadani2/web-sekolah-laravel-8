        ...
        <div class="row h-100 align-items-center">
            <div class="col-12">
                ...
                <div class="hero-content text-center">
                    <h2>Selamat Datang di MA Al-Khoirot</h2>
                    <h4>Jl. Kh Syuhud Zayyadi no. 01 Karangsuko, Pagelaran, Malang</h4>
                    <a href="#" class="btn clever-btn">Madrasah Terbaik</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="regular-page-area section-padding-100 mt-5 mb-4">
    <div class="col-lg-9 mx-auto">
        <div class="card">
            <div class="card-header">Nama Madrasah</div>
            <div class="card-body">
                <p class="lead">
        ...
        <div class="card">
            <div class="card-header">Nama Yayasan</div>
            <div class="card-body">
                <p class="lead">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="lead">
                  Jl. Kh Syuhud Zayyadi no.01 Karangsuko, Pagelaran, Malang
                </p>
            </div>
        </div>
    </div>
